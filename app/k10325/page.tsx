    ...
    const pageChunks = [
      {
        ...
        items: [
          ...
          { type: "安全", item: "屋外用階段・アプローチの滑りやすさ", risk: "雨の日や苔による転倒・骨折リスク", solution: "滑り止めテープの貼付、手すり新設" },
      ...
      },
      {
        ...
        items: [
          ...
          { type: "安全", item: "ドアノブ（ひねるタイプか）", risk: "握力低下により開け閉めが苦痛になる、閉じ込め", solution: "下げるだけのレバーハンドルへの交換、ラッチの交換" },
          { type: "安全", item: "雪見障子など戸のガラス", risk: "転倒や地震での飛散リスク", solution: "割れにくいポリカへの交換" },
      ...
      },
      {
        ...
        items: [
          ...
          { type: "快適", item: "家具・収納扉の開閉", risk: "うまく戸が閉まらない", solution: "丁番（ヒンジ）の交換や調整" },
          { type: "安全", item: "サッシの室内鍵（クレセント錠）", risk: "固くて鍵をかけなくなり、空き巣等の防犯リスク", solution: "クレセント錠の交換・調整、補助錠" },
          { type: "快適", item: "夏場・冬場の室温（断熱性）", risk: "熱中症・ヒートショック予防、電気代節約", solution: "強化・断熱障子、すだれ設置、内窓設置" },
          { type: "快適", item: "部屋の主照明（紐を引っ張るか）", risk: "立ち上がらず、布団から手元で安全に明かりを操作", solution: "リモコン付きLEDシーリングライトへ交換" },
          ...
          { type: "安全", item: "コンセント口、壁スイッチ", risk: "古く傷んだコンセント、見えづらい小さいスイッチ", solution: "新しいコンセント口、大きなパネルのスイッチへ交換" },
          { type: "快適", item: "カーテンの開け閉めの重さ", risk: "毎朝・毎晩の腕への負担、カーテンレールの破損", solution: "レールの潤滑スプレー塗布、ランナー交換、レール入れ替え" },
          { type: "快適", item: "窓ガラスからの冷気", risk: "冷気によるヒートショック、結露カビの発生", solution: "窓ガラス用断熱シート、断熱ガラス交換、内窓の設置" },
          { type: "安全", item: "室内手すりのガタつき", risk: "体重をかけた時に壊れて倒れる危険が高い", solution: "手すりの新設やネジ打ち直し補強" },
          { type: "安全", item: "高所収納、各所照明の玉切れ", risk: "照明不足・暗闇の危険、荷物の落下被害", solution: "寿命の長いLED電球へ一括交換、不用品処分" },
          { type: "安全", item: "避難経路の確保", risk: "経路上の荷物が移動・避難の邪魔になる", solution: "片付けサポート、不用品処分" },
        ]
      },
      {
        title: "水回り",
        items: [
          ...
          { type: "快適", item: "洗面・台所の蛇口（ひねるか）", risk: "握力が落ちても、手の甲で軽く水が出せる", solution: "レバー式水栓（ハンドル）への部品交換・アタッチメント" },
          { type: "快適", item: "お風呂のシャワーヘッド", risk: "立ち座りの負担減、手元で簡単に出し止め・節水", solution: "手元プッシュストップ式のシャワーヘッドへ交換" },
          { type: "安全", item: "キッチンの吊り戸棚（高い収納）", risk: "踏み台から落ちる転落リスク、落下物による怪我", solution: "撤去、昇降式ラックのご提案、移動支援" },
          { type: "安全", item: "シンク下の水漏れ・カビの臭い", risk: "床材の深刻な腐食、シロアリの発生・誘引原因", solution: "水栓交換および水漏れ箇所の特定・修理" },
          { type: "快適", item: "シンク、コンロ周りの壁の油汚れ", risk: "不衛生な環境、虫（ゴキブリ等）の発生原因", solution: "プロによるクリーニングや壁・床の張替え" },
          { type: "快適", item: "台所水栓の利便性", risk: "伸びる水栓で洗いやすく、レバー式で手軽に", solution: "最新の伸びるシャワー水栓へ交換" },
          { type: "快適", item: "洗面台収納扉などの蝶番（ヒンジ）斜め", risk: "扉が斜めに下がり、開閉時に引っかけ・怪我", solution: "蝶番の調整、または新しい金具への交換修理" },
          { type: "安全", item: "洗面所のタオル掛けのガタつき", risk: "よろけて掴んでしまい、壁ごと剥がれる危険", solution: "壁裏の芯材へのネジ打ち直し、アンカーによる補強" },
          { type: "安全", item: "洗面所と浴室の間の敷居の防水", risk: "水漏れ放置による脱衣所床の腐食", solution: "シリコンコーキングによる隙間埋め・CF貼替" },
          { type: "快適", item: "ウォシュレット（温水洗浄便座）", risk: "便座自動開閉、自動洗浄、節水効果が得られる", solution: "便器丸ごとのトイレ交換や便座のみの交換" },
          { type: "快適", item: "洗面台・水栓の水垢や黒ずみ", risk: "水漏れや水質悪化、手入れのしにくさ", solution: "洗面台リフォーム、水栓の新しいものへの交換" },
        ]
      }
    ];
